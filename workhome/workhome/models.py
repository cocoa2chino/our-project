...
class Task(models.Model):
    ...
    contact_type_hunter = models.ForeignKey(Contact, on_delete=models.CASCADE, related_name='contact_hunter',
                                            verbose_name='接收者联系方式', db_constraint=False, null=True,blank=True)
    ...
    hunter = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='hunter', verbose_name='接收者',
